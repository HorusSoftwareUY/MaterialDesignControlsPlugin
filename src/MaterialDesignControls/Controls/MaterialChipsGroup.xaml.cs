...
namespace Plugin.MaterialDesignControls
{
    public partial class MaterialChipsGroup : ContentView, IFieldControl
    {
        ...
        public static readonly BindableProperty LabelScaleProperty =
            BindableProperty.Create(nameof(LabelScale), typeof(ScaleTypes), typeof(MaterialChipsGroup), defaultValue: ScaleTypes.Body3, propertyChanged: OnPropertyChanged);
        ...
        public static readonly BindableProperty AssistiveScaleProperty =
            BindableProperty.Create(nameof(AssistiveScale), typeof(ScaleTypes), typeof(MaterialChipsGroup), defaultValue: ScaleTypes.Body3, propertyChanged: OnPropertyChanged);
        ...
        public static readonly BindableProperty TextScaleProperty =
            BindableProperty.Create(nameof(TextScale), typeof(ScaleTypes), typeof(MaterialChipsGroup), defaultValue: ScaleTypes.Body2, propertyChanged: OnPropertyChanged);
