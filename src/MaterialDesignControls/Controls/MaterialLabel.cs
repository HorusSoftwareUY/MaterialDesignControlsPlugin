...
namespace Plugin.MaterialDesignControls
{
    public class MaterialLabel : Label
    {
        public static new readonly BindableProperty TextProperty =
            BindableProperty.Create(nameof(Text), typeof(string), typeof(MaterialEntry), defaultValue: null);
        ...
        public static readonly BindableProperty TextScaleProperty =
            BindableProperty.Create(nameof(TextScale), typeof(ScaleTypes), typeof(MaterialLabel), defaultValue: ScaleTypes.Caption);
