...
namespace Plugin.MaterialDesignControls
{
    public partial class MaterialButton : ContentView
    {
        ...
        public static readonly BindableProperty BorderColorProperty =
            BindableProperty.Create(nameof(BorderColor), typeof(Color), typeof(MaterialButton), defaultValue: Color.LightGray, propertyChanged: OnPropertyChanged);
        ...
        public static readonly BindableProperty DisabledBorderColorProperty =
            BindableProperty.Create(nameof(DisabledBorderColor), typeof(Color), typeof(MaterialButton), defaultValue: Color.LightGray, propertyChanged: OnPropertyChanged);
