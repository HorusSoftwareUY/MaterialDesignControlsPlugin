...
namespace Plugin.MaterialDesignControls
{
    public partial class MaterialTimePicker : ContentView
    {
        ...
        public static readonly BindableProperty LabelScaleProperty =
            BindableProperty.Create(nameof(LabelScale), typeof(ScaleTypes), typeof(MaterialTimePicker), defaultValue: ScaleTypes.Body3, propertyChanged: OnPropertyChanged);
        ...
        public static readonly BindableProperty AssistiveScaleProperty =
            BindableProperty.Create(nameof(AssistiveScale), typeof(ScaleTypes), typeof(MaterialTimePicker), defaultValue: ScaleTypes.Body3, propertyChanged: OnPropertyChanged);
