...
namespace Plugin.MaterialDesignControls.Material3
{
    ...
    public class MaterialSegmented : ContentView
    {
        ...
        public static readonly BindableProperty CornerRadiusProperty =
            BindableProperty.Create(nameof(CornerRadius), typeof(float), typeof(MaterialSegmented), defaultValue: 16.0);
            ...
            if (ItemsSource != null)
            {
                ...
                foreach (var item in ItemsSource)
                {
                    ...
                    if (Type == MaterialSegmentedType.Outlined)
                    {
                        ...
                        _mainFrame.BorderColor = BorderColor;
                        _mainFrame.BackgroundColor = BorderColor;
                        frame.Padding = new Thickness(12, 0);
